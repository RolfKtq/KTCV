...
@Component({
  selector: 'app-cv-erfaring',
  templateUrl: './cv-erfaring.component.html',
  styleUrls: ['./cv-erfaring.component.css']
})
export class CvErfaringComponent implements OnInit {
  ...
  endrerPdf(element) {
    ...
    if (element.slett_image) {
      ...
      //this.redigerObjekt.image_id = 'slett';
