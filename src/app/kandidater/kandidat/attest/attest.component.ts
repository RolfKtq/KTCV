...
@Component({
  ...
  styleUrls: ['./attest.component.css']
})
export class AttestComponent implements OnInit, OnChanges {
  @Input() kandidat: any;
  ...
  cvEndring(e) {
    console.log('Noe ble enderet (Linje 52 attest.component.ts)');
